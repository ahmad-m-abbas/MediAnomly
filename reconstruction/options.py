...
class Options:
    ...
    def parse(self):
        ...
        parser.add_argument("--grad-pen-weight", type=float, default=1e-4, help="grad_pen_weight")
        ...
        self.train['beta'] = args.beta
        self.train['grad_pen_weight'] = args.grad_pen_weight
