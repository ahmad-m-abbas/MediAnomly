...
class VAEWorker(AEWorker):
    ...
    def train_epoch(self):
        self.net.train()
        losses, recon_losses, kl_losses, embedding_losses, grad_losses = AverageMeter(), AverageMeter(), AverageMeter(), AverageMeter(), AverageMeter()
        for idx_batch, data_batch in enumerate(self.train_loader):
            ...
            embedding_losses.update(embedding_loss, bs)
            grad_losses.update(grad_penalty, bs)
        return losses.avg, recon_losses.avg, kl_losses.avg, embedding_losses.avg, grad_losses.avg
    ...
    def run_train(self):
        ...
        for epoch in range(1, num_epochs + 1):
            ...
            self.logger.log(step=epoch, data={"train/loss": train_loss,
                                              ...
                                              "train/embedding": embedding_loss,
                                              "traing/grad": grad_penalty})
